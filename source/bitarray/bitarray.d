...
class BitArray {
    ...
    private uint length_;  //the length of the bitarray
...
class SuccinctBitVector : BitArray {
    ...
    void build() {
        ...
        this.n_large_blocks = this.length_/this.large_block_size + 1;
        this.n_small_blocks = this.length_/this.small_block_size + 1;
